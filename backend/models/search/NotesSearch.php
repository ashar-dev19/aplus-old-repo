...
/**
 * NotesSearch represents the model behind the search form about `backend\models\Notes`.
 */
class NotesSearch extends Notes
{
    ...
    {
        return [
            [['id', 'student_id', 'grade_id', 'category_id', 'status', 'created_by', 'updated_by', 'published_at', 'created_at', 'updated_at'], 'integer'],
