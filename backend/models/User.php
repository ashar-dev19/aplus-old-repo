...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['company_id', 'branch_id', 'status', 'superadmin', 'created_at', 'updated_at', 'email_confirmed'], 'integer'],
            [['username', 'last_login', 'auth_key', 'password_hash', 'created_at', 'updated_at'], 'required'],
            [['last_login'], 'safe'],
