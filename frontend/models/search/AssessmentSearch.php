...
class AssessmentSearch extends Assessment
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['first_name', 'last_name', 'phone', 'email', 'children_count', 'grades', 'education_satisfaction', 'created_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'first_name', $this->first_name])
            ...
            ->andFilterWhere(['like', 'children_count', $this->children_count])
            ->andFilterWhere(['like', 'grades', $this->grades])
            ->andFilterWhere(['like', 'education_satisfaction', $this->education_satisfaction]);
